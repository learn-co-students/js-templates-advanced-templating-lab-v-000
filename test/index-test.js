describe('Handlebars Templates Lab', function() {
  ...
  describe('templates', function() {
    it('has a recipe template', function() {
      let recipeTemplate = document.getElementById("recipe-template")
    ...
    it('has a recipe details partial template', function() {
      let recipeDetailsPartial = document.getElementById("recipe-details-partial")
  ...
  describe('functions', function() {
    ...
    describe('displayEditForm', function() {
      it('renders the edit form template', function() {
        init()
        createRecipe()
        let spy = expect.spyOn(window.Handlebars, "compile").andCallThrough()
        displayEditForm()
